# 🌧️ Dashboard Hujan Kota Bandung
...
* `scraping_curah_hujan_ex.py`: File untuk scraping data ke situs Open-Meteo.
* `curah_hujan_bandung.xlsx`: File data dari hasil scraping.
